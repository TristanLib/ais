...
Corresponding author: Li Bo, li.bo@cmaritime.com.cn
...
|---|---:|---|
| Source dates | 4 | Multi-date historical AIS sample; not a seasonal or global coverage claim. |
| Trajectory windows | 186,326 | Adequate scale for a benchmark-style evaluation. |
| Unique MMSI values | 7,425 | Broad vessel-identity coverage for vessel-disjoint testing. |
| Mean SOG | 2.22 kn; max 34.88 kn | Low-speed traffic is prominent, so aggregate metrics are interpreted with slice results. |
| Temporal-test speed bins | 0-2 kn 20,601 (73.7%); 2-8 kn 4,772 (17.1%); 8-15 kn 2,205 (7.9%); 15-50 kn 372 (1.3%) | The temporal test set is low-speed dominated. |
| Temporal-test regions | east_gulf_coast 22,583 (80.8%); hawaii_pacific 213 (0.8%); other 550 (2.0%); west_coast 4,604 (16.5%) | Region composition is not balanced; regional robustness is not claimed. |
| Interpolation ratio | mean 0.181; max 0.244 | Interpolation is moderate and remains a possible contributor to tail errors. |
| Turn intensity | mean 17.69 deg; max 148.8 deg | Manoeuvring heterogeneity supports horizon and slice analysis. |
| Risk-warning scenarios | 2,000 scenarios; 520 truth warnings; median observed CPA 1.302 nmi; median observed TCPA 7.0 min; regions: east_gulf_coast 991, west_coast 953, hawaii_pacific 41, other 15 | Decision-support slice, not a full encounter-population model. |
...
Table 2 gives the numerical trajectory results. The distinction between mean and median is important. For example, Kalman-CV has median ADE 8.2 m on the temporal holdout and 9.2 m on the vessel-disjoint holdout, while its mean ADE remains much larger. This pattern is consistent with many short windows being easy and a smaller number of windows being difficult due to manoeuvres, sparse/interpolated reporting, regional geometry or other traffic effects.
...
|---|---|---:|---:|---:|---:|---:|---:|
| Temporal holdout | Kalman-CV | 8.2 | 1,009.7 | 2,120.6 | 34,576.1 | 1,759.7 | 484.0 |
| Temporal holdout | CV | 20.5 | 998.8 | 1,990.6 | 34,946.8 | 2,751.3 | 482.0 |
| Temporal holdout | Ridge | 1,563.1 | 2,934.6 | 4,857.6 | 39,372.3 | 3,141.7 | 2,057.0 |
| Temporal holdout | OLS | 1,439.3 | 2,767.1 | 4,916.5 | 36,361.0 | 3,052.3 | 1,933.4 |
| Vessel-disjoint holdout | Kalman-CV | 9.2 | 1,197.7 | 3,186.6 | 46,157.6 | 3,109.4 | 753.2 |
| Vessel-disjoint holdout | CV | 22.8 | 1,203.2 | 2,991.4 | 46,265.6 | 9,553.5 | 759.5 |
| Vessel-disjoint holdout | Ridge | 1,277.5 | 2,516.6 | 4,391.9 | 47,065.1 | 3,446.9 | 1,875.4 |
| Vessel-disjoint holdout | OLS | 930.0 | 2,229.2 | 4,131.3 | 47,434.3 | 8,113.3 | 1,564.0 |
...
Li Bo is the sole author and was responsible for study conception, methodology, software workflow, validation, formal analysis, interpretation, manuscript drafting and final approval.
