...
- Supplementary archive: `paper/jon_supplementary_materials.zip` (0.31 MB)

## Current Automated Status

- Article type: Research Article.
- Main text word count estimate: 6,152 words including declarations and references.
...
- `paper/figures/jon_pipeline_protocol.png`
- `paper/figures/jon_model_performance.png`
- `paper/figures/jon_horizon_degradation.png`
- `paper/figures/jon_risk_warning_metrics.png`
- `paper/figures/jon_scenario_slice_errors.png`
- `paper/figures/jon_risk_case_studies.png`
